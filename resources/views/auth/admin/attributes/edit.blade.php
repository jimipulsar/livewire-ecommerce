                        ...
                        <div class="col-span-9 sm:col-span-4">
                            <div class="grid grid-cols-12 gap-6 py-3">
                                <div class="col-span-6 sm:col-span-6">
                                    <label for="name"
                                           class="block my-2 text-sm font-medium text-gray-700">Nome attributo</label>
                                    <input type="text" name="name" id="name"
                                           class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{$attribute->name}}">
                                </div>
                                <div class="col-span-6 sm:col-span-6">
                                    <label for="code"
                                           class="block my-2 text-sm font-medium text-gray-700">Tipologia</label>
                                    <input type="text" name="code" id="code"
                                           class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{$attribute->code}}"
                                    >
                                </div>
